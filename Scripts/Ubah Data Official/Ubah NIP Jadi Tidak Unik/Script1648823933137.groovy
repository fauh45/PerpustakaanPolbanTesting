...
WebUI.waitForElementVisible(findTestObject('Object Repository/Perpustakaan Polban/Page_Perpustakaan/input__nip'), 0)

WebUI.setText(findTestObject('Object Repository/Perpustakaan Polban/Page_Perpustakaan/input__nip'), '6942070')

WebUI.click(findTestObject('Object Repository/Perpustakaan Polban/Page_Perpustakaan/button_SUBMIT'))

WebUI.verifyElementText(findTestObject('Object Repository/Perpustakaan Polban/Page_Perpustakaan/div_Cannot save data, because username atau_90f2df'), 
    'Field NIP should be uniq with data has been registered')
