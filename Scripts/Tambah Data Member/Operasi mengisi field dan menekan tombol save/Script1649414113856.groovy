...
WebUI.verifyElementClickable(findTestObject('Object Repository/Page_Perpustakaan/a_User Management'))

WebUI.click(findTestObject('Object Repository/Page_Perpustakaan/a_User Management'))

WebUI.verifyElementClickable(findTestObject('Object Repository/Page_Perpustakaan/button_Add'))
...
WebUI.setText(findTestObject('Object Repository/Page_Perpustakaan/input__name'), 'Bule')

WebUI.setText(findTestObject('Object Repository/Page_Perpustakaan/input__email'), 'bule@email.com')

WebUI.setText(findTestObject('Object Repository/Page_Perpustakaan/input__nim'), '191524999')
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Perpustakaan/div_users data successfully saved'), 'user\'s data successfully saved.')
