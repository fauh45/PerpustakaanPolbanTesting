...
WebUI.setText(findTestObject('Object Repository/Page_Perpustakaan/input_NIMNIP_nip'), '08123121')

WebUI.setText(findTestObject('Object Repository/Page_Perpustakaan/input_Description_description'), 'Head Of Library')

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Perpustakaan/select_-- Select All --ActivePendingNon Active'), 
    'ST1', true)
