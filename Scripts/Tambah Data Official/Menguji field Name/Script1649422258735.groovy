...
WebUI.click(findTestObject('Object Repository/Page_Perpustakaan/span_User Management'))

WebUI.click(findTestObject('Object Repository/Page_Perpustakaan/button_Add'))

WebUI.setText(findTestObject('Object Repository/Page_Perpustakaan/input__name'), 'Akulah Cinta Di Langit Prudence Lovely Princess Of Awanamp')
...
WebUI.click(findTestObject('Object Repository/Page_Perpustakaan/div_-- Select One --ADMINISTRATORMEMBEROFFICIAL'))
...
WebUI.setText(findTestObject('Object Repository/Page_Perpustakaan/input__nip'), '2010732')
